...
Reads consolidated.findings, sorts by dimensional priority (ordinal tuple
of runtime_scope, failure_mode, evidence_quality, trace_origin) descending
with content_hash as deterministic tie-break, then writes
...
def main(argv: list[str]) -> int:
    ...
    indexed.sort(key=lambda t: (tuple(-x for x in _priority(t[1])), t[1]["content_hash"]))
